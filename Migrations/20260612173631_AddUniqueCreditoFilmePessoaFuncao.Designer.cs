...
namespace CineRank.Migrations
{
    ...
    [Migration("20260612173631_AddUniqueCreditoFilmePessoaFuncao")]
    partial class AddUniqueCreditoFilmePessoaFuncao
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CineRank.Models.Credito", b =>
                {
                    ...
                    b.HasIndex("FilmeId", "PessoaId", "FuncaoId")
                        .IsUnique();

                    b.ToTable("Creditos");
                });

            modelBuilder.Entity("CineRank.Models.Favorito", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
